...
var vuexStore = function vuexStore(store) {
    initAlong(store);
...
var setWatch = function setWatch(arry) {
    ...
    if (!Array.isArray(arry) || typeof isWatch != 'boolean') {
        return console.error('[vuex-storage] params of watch has error');
    }
...
var setOnlySession = function setOnlySession(bool) {
    if (typeof bool != 'boolean') {
        return console.error('[vuex-storage] params of onlySession has error');
    }
    onlySession = bool;
};
...
vuexStore.watch = watch;
vuexStore.watchSession = watchSession;
vuexStore.onlySession = setOnlySession;
vuexStore.clean = removeItem;
window.cleanVuexStore = removeItem;